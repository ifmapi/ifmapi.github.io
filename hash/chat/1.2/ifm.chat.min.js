...
(function() {
  ...
  Ifm.Chat = (function() {
    ...
    function setupCandy() {
      ...
      $(Candy).on('candy:view.connection.status-6', function(evt, args) {
        ...
        if (!_userDisconnected) {
          ...
          if (msg)
            setTimeout(function() {
              Candy.View.Pane.Chat.Modal.show(msg)
            }, 200)
        }
        return false
      });
    ...
    return {
        about: {
          name: "Ifm.Chat", product: "#phones", version: "1.2.17-4685"
        }, events: defineEvents("initialized", "newchat", "newmessage", "sysmessage", "chatclosed", "filetransfer"), getCallInfo: function() {
            return _callInfo
