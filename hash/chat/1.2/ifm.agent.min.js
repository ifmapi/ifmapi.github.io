...
(function() {
  ...
  Ifm.phonebarIntegration = (function() {
    ...
    return {
        about: {
          name: "Ifm.phonebarIntegration", product: "#phones", version: "1.2.20-5240"
...
(function() {
  ...
  Spinner.show = function() {
    ...
    new Spinner({
      lines: 12, length: 20, width: 10, radius: 30, corners: 1, rotate: 0, direction: 1, color: 'white', speed: 1, trail: 60, shadow: false, hwaccel: false, className: 'spinner', zIndex: 2e9, top: '50%', left: '50%'
    }).spin(box)
  };
