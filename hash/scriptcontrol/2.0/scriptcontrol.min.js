...
(function() {
  ...
  ns.instance = (function() {
    ...
    var phonebarType = 0;
    var scriptControlVersion = "2.1.3.0";
    var phonebarVersion = "";
    ...
    instance.events = defineEvents("onconnected", "ondisconnected", "onabortcallreply", "onalertingevent", "onansweredevent", "onassignmentrequest", "onrecordingcompletedevent", "onrecordingmutedevent", "onrecordingstartedevent", "onaudiorecordingcompletedevent", "onaudiorecordingmutedevent", "onaudiorecordingstartedevent", "onbookedevent", "oncallfailureevent", "oncalltransferinitiatedevent", "onconnectionremovedevent", "ondeviceinfochangedevent", "ondisplaynamechangedevent", "onphonebarclosedevent", "onloginreply", "onlogoutreply", "onnewcallreply", "onothercallevent", "onpauseevent", "onpausereply", "onphonebarconnectionlostevent", "onpostcallworkevent", "onreadyevent", "onreadyfordetachevent", "onreadyfordetachexevent", "onreadyfordetacheventex", "onreadyreply", "onreadyfortransferevent", "onretrievecallreply", "onrejectableassignmentrequest", "onterminatedevent", "ontransferreply", "onmaskeddigitreceivedevent", "onmaskedpayloadreceivedevent", "oninitialized", "onoverridenbuttonclickevent", "onpausebookedevent", "onstatechangedevent", "onsupervisormessageevent", "onphonedeviceconnectedevent", "onphonedevicedisconnectedevent", "onphonedeviceregisteredstateevent", "onphonedeviceregisteredstatechangedevent", "onphonedevicelinestatechangedevent", "onphonedeviceconferencestateevent", "onphonedeviceconferencestatechangedevent", "onphonedeviceselectedlinechangedevent", "onphonedevicecallingevent", "onphonedevicecallconnectedevent", "onphonedevicecalldisconnectedevent", "onphonedevicedisplaynameevent", "onphonedeviceincomingcallevent", "onphonedeviceringevent", "onphonedevicemuteevent", "onxmppdeviceinitializedevent", "onxmppdeviceregisteredstateevent", "onxmppdeviceregisteredstatechangedevent", "onxmppdevicenewcallevent", "onxmppdevicecallclosedevent", "onxmppdevicefiletransferevent", "onxmppdevicemessagereceivedevent", "onqueueinforeply", "onagentslistreply", "oncampaignslistreply", "onpausereasonslistreply", "onagentdetailsreply", "oncalldetailsreply", "ongetbuttonenabledreply", "onoverridebuttonreply", "oncommandexecutedevent");
    Object.defineProperties(instance, {
      domain: {get: function() {
          return domain
    ...
    instance.overridebutton = function(buttonid, override) {
      console.debug("[ScriptControl.js] OverrideButton");
      if (phonebarType === 0) {
        console.debug("[ScriptControl.js] Unsupported with Phonebar Legacy")
      }
      else {
        var e = {
            buttonId: buttonid, override: override
          };
        sendMessageToPhonebarRich(20034, 0, e)
      }
    };
    instance.overridenbuttonclickwasmanaged = function(buttonid, requestid, managed) {
      console.debug("[ScriptControl.js] OverridenButtonClickWasManaged");
      if (phonebarType === 0) {
        console.debug("[ScriptControl.js] Unsupported with Phonebar Legacy")
      }
      else {
        var e = {
            buttonId: buttonid, requestId: requestid, managed: managed
          };
        sendMessageToPhonebarRich(20101, 0, e)
      }
    };
    ...
    function onPhonebarClassicMessage(message) {
      ...
      switch (msgCode) {
        ...
        case"20005":
          ...
          instance.events.onaudiorecordingcompletedevent.raise({
            callid: msg.data[0], result: msg.data[1]
          });
          break;
        case"20006":
          ...
          instance.events.onaudiorecordingmutedevent.raise({
            callid: msg.data[0], txchannelmuted: msg.data[1], rxchannelmuted: msg.data[2]
          });
          break;
        case"20007":
          ...
          instance.events.onaudiorecordingstartedevent.raise({
            callid: msg.data[0], recfilename: msg.data[1]
          });
          break;
        case"20008":
        ...
        case"20033":
          ...
          instance.events.onreadyfordetacheventex.raise({
            campaign: msg.data[0], callid: msg.data[1], callterminated: msg.data[2], protocolterminationcause: msg.data[3], protocolterminationdescription: msg.data[4], detectedcontentcode: msg.data[5], detectedcontentdescription: msg.data[6]
          });
          break;
        case"40008":
      ...
      switch (msgCode) {
        ...
        case 11004:
          if (isRegisterdForCampaignLessEvents()) {
            ...
            instance.events.onphonedeviceregisteredstatechangedevent.raise({registered: msg.isRegistered})
          }
          break;
        case 11005:
          if (isRegisterdForCampaignLessEvents()) {
        ...
        case 11006:
          if (isRegisterdForCampaignLessEvents()) {
            ...
            instance.events.onphonedeviceconferencestatechangedevent.raise({inconference: msg.inConference})
          }
          break;
        case 11007:
          if (isRegisterdForCampaignLessEvents()) {
        ...
        case 12002:
          if (isRegisterdForCampaignLessEvents()) {
            ...
            instance.events.onxmppdeviceregisteredstatechangedevent.raise({registered: true})
          }
          break;
        case 12003:
          if (isRegisterdForCampaignLessEvents()) {
            instance.events.onxmppdeviceregisteredstateevent.raise({registered: false});
            instance.events.onxmppdeviceregisteredstatechangedevent.raise({registered: false})
          }
          break;
        case 12004:
          if (msg.callId && activeCalls[msg.callId]) {
        ...
        case 12007:
          ...
          break;
        case 13001:
          console.debug("[ScriptControl.js] OverridenButtonClickEvent", "ButtonId:", msg.buttonId, "- RequestId:", msg.requestId, "- Details:", JSON.stringify(msg.details));
          if (isRegisterdForCampaignLessEvents()) {
            instance.events.onoverridenbuttonclickevent.raise({
              buttonid: msg.buttonId, requestid: msg.requestId, details: msg.details
            })
          }
          break;
        case 30001:
        ...
        case 30013:
          ...
          break;
        case 30014:
          console.debug("[ScriptControl.js] OverrideButtonReply", "ButtonId:", msg.buttonId, "- Accepted:", msg.accepted);
          instance.events.onoverridebuttonreply.raise({
            buttonid: msg.buttonId, accepted: msg.accepted
          });
          break
      }
    }
