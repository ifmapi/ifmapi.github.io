...
(function() {
  ...
  ns.CampaignInfoFlags = {
    Inactive: 0x1, Active: 0x2, Suspended: 0x4, AnyStatusMask: 0x7, Inbound: 0x8, Outbound: 0x10, AnyBoundness: 0x18, NotAssigned: 0x20, Assigned: 0x40, AnyAssignment: 0x60, PostCallWork: 0x80, HideTransferNotAllowed: 0x100, ExcludeSyntheticCampaigns: 0x200, ExcludeHumanCampaigns: 0x400
  };
...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.78-4675"
  };
  ...
  PhoneBar.instance = (function(PhoneBar) {
    ...
    function goReady() {
      if ((currentState !== states.Ready) || isBooked) {
        ...
        events.ready.raise(self, {callId: null})
      }
    }
      ...
      calls: function(filter) {
        ...
        return c
          ...
          if (callId && self.calls(callId))
            mediatype = self.calls(callId).mediatype;
          var mask = 378;
...
namespace("Ifm.PhoneBar.UI").Elements = {
