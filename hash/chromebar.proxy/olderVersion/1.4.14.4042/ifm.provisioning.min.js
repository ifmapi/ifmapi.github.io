...
(function () {
    ...
    return provisioningGetConfigurationSection(endPoint, token, username, topic || defTopic, subject || defSubject)
      .then(remoteInfo => {
        ...
        if (remoteInfo.data) {
          ...
          return { error: "SiteList not received!" }
        }
      })
      .catch(error => {
  ...
  function getConfig(username, token, /*[opt]*/ site, /*[opt]*/ product, /*[opt]*/ topic, /*[opt]*/ subject) {
    ...
    return provisioningGetConfigurationSection(endPoint, token, username, topic || defTopic, subject || defSubject, site || "default")
      .then(remoteInfo => {
        if (remoteInfo.data) {
