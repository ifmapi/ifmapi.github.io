...
(function() {
  ...
  ns.about = {
    title: "softphone.js", version: "1.0.9-5763"
  };
  ns.instance = (function() {
    ...
    instance.setAudioDevice = function(role, callback) {
      sendMessage("#setaudiodevice", "|" + role, callback)
    };
...
(function() {
  ...
  SPC.prototype._setAudioDevice = function(deviceRole) {
    let deviceRoleValue;
    if (deviceRole === Phone.AudioDevice.Default) {
      deviceRoleValue = 0
    }
    else {
      deviceRoleValue = 1
    }
    this.phonebar.log(THIS, DEBUG, "Setting audio to role " + deviceRoleValue);
    this.softphone.setAudioDevice(deviceRoleValue)
  };
  ...
  SPC.prototype._register = function(domain, extension) {
    domain = (domain !== undefined && domain !== null) ? domain : this.domain;
    extension = (extension !== undefined && extension !== null) ? extension : this.phonebar.agent.extension;
    if (!domain || !extension) {
      this.phonebar.log(THIS, WARN, "Cannot register without domain and extension");
