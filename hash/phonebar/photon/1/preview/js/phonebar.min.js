...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-0009"
  };
      ...
      calls: function(filter) {
        ...
        return c
          ...
          try {
            ...
            if (_config.useProvisioning && (!_settings.Metadata || Object.keys(_settings.Metadata).length === 0)) {
              try {
                const persistedMetadata = localStorage.getItem(METADATA_KEY);
                if (persistedMetadata) {
                  _settings.Metadata = JSON.parse(persistedMetadata);
                  console.debug('[PhoneBar] Loaded persisted Metadata from localStorage:', JSON.stringify(_settings.Metadata))
                }
              }
              catch(e) {
...
(function(PhoneBar) {
  PhoneBar.ConfigTemplate = {
    config: {
      useProvisioning: false, language: "it", service: [], phoneDevice: "", enableOAuth2: false, authorityUrl: "", authorityIsAdfs: false, clientId: "", scopes: ["api://hashphones/PhoneBar.All"], recordingsPath: ""
    }, softphoneconfig: {
        service: "", domain: ""
      }, webrtcconfig: {SBCConfig: {
          domain: "", addresses: ["wss://webrtc.voip.ifmcommunications.it"], iceServers: ["stun.l.google.com:19302"], useDomainOfLoggedUser: true
        }}, xmppconfig: {
        ...
        hideClockInPause: false, hidePausedAgents: false, autoAnswerPhone: 1, autoAnswerRings: 1, callingNumber: "", disableManualCall: false, rememberCredentials: 2, loginOnStart: 0, popupIncomingCall: 1 + 8 + 16
      }
  }
})(Ifm.PhoneBar)
