...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-DE04"
  };
...
(function(PhoneBar) {
  PhoneBar.ConfigTemplate = {
    config: {
      useProvisioning: true, language: "it", service: [], phoneDevice: "", enableOAuth2: false, authorityUrl: "", authorityIsAdfs: false, clientId: "", scopes: ["api://hashphones/PhoneBar.All"], recordingsPath: ""
    }, softphoneconfig: {
        service: "", domain: ""
