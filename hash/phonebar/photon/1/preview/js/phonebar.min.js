...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-DE06"
  };
        ...
        return c
          ...
          function normalizeProvisioningStructure(provisioning) {
            ...
            if (normalized.Metadata && normalized.Metadata.config === false) {
              ...
              console.debug('[PhoneBar] Normalized Metadata after config propagation:', JSON.stringify(normalized.Metadata))
            }
          ...
          try {
            ...
            if (template) {
              ...
              if (localOverrides && Object.keys(localOverrides).length > 0) {
                ...
                _settings = mergedSettings;
                _config = mergedSettings.config || {};
                console.debug('[PhoneBar] Configuration merged');
