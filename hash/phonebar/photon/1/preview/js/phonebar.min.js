...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-0012"
  };
    ...
    config: {
      useProvisioning: false, language: "it", service: [], phoneDevice: "", enableOAuth2: false, authorityUrl: "", authorityIsAdfs: false, clientId: "", scopes: ["api://hashphones/PhoneBar.All"], recordingsPath: ""
        ...
        service: "", domain: ""
          ...
          domain: "", addresses: ["wss://webrtc.voip.ifmcommunications.it"], iceServers: ["stun.l.google.com:19302"], useDomainOfLoggedUser: false
        }}, xmppconfig: {
