...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-0008"
  };
      ...
      calls: function(filter) {
        ...
        return c
          ...
          try {
            ...
            if (_config.useProvisioning) {
              if (!_settings.Metadata || Object.keys(_settings.Metadata).length === 0) {
                try {
              ...
              if (_settings.Metadata && Object.keys(_settings.Metadata).length > 0) {
                try {
                  localStorage.setItem(METADATA_KEY, JSON.stringify(_settings.Metadata));
                  console.debug('[PhoneBar] Persisted Metadata to localStorage:', JSON.stringify(_settings.Metadata))
                }
                catch(e) {
