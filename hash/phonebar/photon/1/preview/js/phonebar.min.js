...
(function(PhoneBar) {
  PhoneBar.about = {
    product: "#phones", title: "#phonebar", version: "1.0.95-0001"
  };
        ...
        return c
          ...
          try {
            ...
            if (template) {
              ...
              if (_config.useProvisioning && _originalSettings.Metadata && Object.keys(_originalSettings.Metadata).length > 0) {
                try {
                  localStorage.setItem(METADATA_KEY, JSON.stringify(_originalSettings.Metadata));
                  console.debug('[PhoneBar] Persisted final Metadata to localStorage:', JSON.stringify(_originalSettings.Metadata))
                }
                catch(e) {
