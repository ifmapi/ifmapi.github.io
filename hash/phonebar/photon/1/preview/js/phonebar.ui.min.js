...
Ifm.PhoneBar.UI.Commands = (function() {
  ...
  function onKeyUp(event) {
    if (event.ctrlKey || event.shiftKey) {
      switch (event.code) {
        case'F2':
          jQuery(el.LoginOrReadyButton).click();
          event.preventDefault();
          break;
        case'F3':
          jQuery(el.PauseButton).click();
          event.preventDefault();
          break;
        case'F4':
          jQuery(el.LogoutButton).click();
          event.preventDefault();
          break;
        case'F5':
          jQuery(el.CallButton).click();
          ...
          break;
        case'F6':
          jQuery(el.TransferButton).click();
          event.preventDefault();
          break;
        case'F7':
          jQuery(el.CampaignListButton).click();
          event.preventDefault();
          break;
        case'F8':
          jQuery(el.ManualTransferButton).click();
          event.preventDefault();
          break;
        case'F9':
          if (jQuery(el.PickupButton).enabled()) {
            jQuery(el.PickupButton).click();
            event.preventDefault()
          }
          else if (jQuery(el.HangupButton).enabled()) {
            jQuery(el.HangupButton).click();
            event.preventDefault()
          }
          break;
        case'F10':
        case'F11':
          jQuery(el.FlashButton).click();
          event.preventDefault();
          break;
        case'F12':
          jQuery(el.MainMenuButton).click();
          event.preventDefault();
          break;
        case'Digit1':
          jQuery(el.Line1Button).click();
          event.preventDefault();
          break;
        case'Digit2':
          jQuery(el.Line2Button).click();
          event.preventDefault();
          break;
        case'KeyF':
          if (jQuery(el.EnterConferenceButton).enabled()) {
            jQuery(el.EnterConferenceButton).click();
            event.preventDefault()
          }
          else if (jQuery(el.LeaveConferenceButton).enabled()) {
            jQuery(el.LeaveConferenceButton).click();
            event.preventDefault()
          }
          break;
        case'KeyM':
          if (jQuery(el.MicrophoneOffButton).enabled()) {
            jQuery(el.MicrophoneOffButton).click();
            event.preventDefault()
          }
          else if (jQuery(el.MicrophoneOnButton).enabled()) {
            jQuery(el.MicrophoneOnButton).click();
            event.preventDefault()
          }
          break
      }
  ...
  function showIncomingCallPopup(callingNumber, campaignName) {
    ...
    Ifm.Dom.Photon.Cards.show(html, "incoming-call-card", false, false, 0, strings.IncomingCallText, {
      width: 600, height: 207, topmost: true
    })
  }
